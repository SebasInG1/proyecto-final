...
inscribeRouter.get('/:cod_i', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const cod_i = parseInt(req.params.cod_i);
    inscribeController.getById(cod_i, (err, result) => {
        if (err) {
            return res.status(500).json({ 'message': err.message });
        }
        res.status(result.statusCode).json(result);
...
inscribeRouter.put('/:cod_i', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const cod_i = parseInt(req.params.cod_i);
    const updatedInscribe = Object.assign(Object.assign({}, req.body), { cod_i });
...
inscribeRouter.delete('/:cod_i', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const cod_i = parseInt(req.params.cod_i);
    inscribeController.remove(cod_i, (err, result) => {
        if (err) {
            return res.status(500).json({ 'message': err.message });
        }
        res.status(result.statusCode).json(result);
